...
class FG_eval {
 public:
  ...
  const double para_cte = 2.5; // cost factor. the higher this factor the more aggressively we try to return to the trajectory
  const double para_epsi = 1; // cost factor. the higher this factor the more stable our steering is
  const double para_vec = 1; // cost factor. the higher this factor the more stable our steering is
  const double para_steering = 2000; // cost factor. the higher this factor the more stable our steering is
